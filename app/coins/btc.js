...
module.exports = {
	...
	// Address patterns for Bitcoin
	addressPatterns: {
		main: /^[13].*$/, // Bitcoin mainnet addresses start with 1 or 3
		test: /^[2mn].*$/, // Bitcoin testnet addresses start with 2, m, or n
		regtest: /^[2mn].*$/, // Bitcoin regtest addresses start with 2, m, or n
		signet: /^[2mn].*$/, // Bitcoin signet addresses start with 2, m, or n
	},
