...
const currentCoin = process.env.BTCEXP_COIN || "VTO";

const rpcCred = credentials.rpc;

const cookieSecret = process.env.BTCEXP_COOKIE_SECRET || (rpcCred.password && crypto.createHmac("sha256", JSON.stringify(rpcCred)).update("btc-rpc-explorer-cookie-secret").digest("hex")) || "0x000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f";
...
["BTCEXP_DEMO", "BTCEXP_PRIVACY_MODE", "BTCEXP_NO_INMEMORY_RPC_CACHE", "BTCEXP_RPC_ALLOWALL", "BTCEXP_ELECTRUM_TXINDEX", "BTCEXP_UI_HIDE_INFO_NOTES"].forEach(function (item) {
...
module.exports = {
	...
	displayDefaults: {
		displayCurrency: process.env.BTCEXP_DISPLAY_CURRENCY || "vto",
	...
	siteTools: [
		...
		/* 13 */ { name: "Whitepaper Extractor", url: "./bitcoin-whitepaper", desc: "Extract whitepapers from data embedded within the blockchain.", iconClass: "bi-file-earmark-text" },
		...
		/* 17 */ { name: "Quotes", url: "./quotes", desc: "Curated list of cryptocurrency-related quotes.", iconClass: "bi-chat-quote" },

		/* 18 */ { name: "UTXO Set", url: "./utxo-set", desc: "View the latest UTXO Set.", iconClass: "bi-list-columns" },

		/* 19 */ { name: "Holidays", url: "./holidays", desc: "Curated list of cryptocurrency 'Holidays'.", iconClass: "bi-calendar-heart" },
