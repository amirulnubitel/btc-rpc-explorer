...
const blacklistedAddresses = ["bc1q4fkjqusxsgqzylcagra800cxljal82k6y3ejay", "bc1qvmvz53hdauzxuhs7dkm775tlqtd9vpk8ux7mqj", "bc1qtms60m4fxhp5v229kfxwd3xruu48c4a0tqwafu", "bc1qvkvzfla6wrem2uf4ejkuja8yp3c6f3xf72kyc9", "bc1qnxwt7sr3rqatd6efjyym3nsgxhslyzeqndhjpn"];
...
router.get(
	...
	asyncHandler(async (req, res, next) => {
		try {
			...
			let timePeriods = [1 * blocksPerDay, 7 * blocksPerDay, 30 * blocksPerDay, 90 * blocksPerDay, 365 * blocksPerDay];
